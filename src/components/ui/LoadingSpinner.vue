// This was copied from the Hexagon component from vue-loading-spinner
// https://github.com/nguyenvanduocit/vue-loading-spinner/blob/master/src/components/Hexagon.vue
<template>
...
<style lang="scss" scoped>
    ...
    .spinner-inner {
        ...
        &:before {
            ...
            display: block;
            position: absolute;
            border: 7px solid map-get($theme-colors, secondary);
            border-radius: 50%;
            top: -2px;
            left: -2px;
    ...
    .hexagon {
        ...
        &:before {
            ...
            border-bottom: 11.5px solid map-get($theme-colors, primary);
        }
        &:after {
            content: "";
            position: absolute;
            ...
            border-left: 20px solid transparent;
            border-right: 20px solid transparent;
            border-top: 11.5px solid map-get($theme-colors, primary);
        }
    }
    @each $index,
    $top,
